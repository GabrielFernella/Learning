...
const makeSut = (): SutTypes => {
  // O factory serve para que caso haja alguma alteração de dependencia da classe, vc altere apenas aqui, que afetará os restos dos testes
...
describe('SignUpController', () => {
  ...
  test('Should return 400 if ab invalid email is provider', () => {
